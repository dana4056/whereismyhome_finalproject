  ...
  <div>
    <section class="container align-middle p-5">
      <caption>
        ...
        <router-link to="/freeboard/create" type="button" class="addbtn px-5"> <i class="fa-solid fa-circle-plus fa-2x"></i></router-link>
      </caption>
      ...
      <b-navbar>
        ...
        <b-navbar-nav>
          ...
          &nbsp;
          <nav-item @click="freeboardSort(2)" :class="{sortLetter : sortType == 2}">조회수순</nav-item>
          &nbsp;
          <nav-item @click="freeboardSort(3)" :class="{sortLetter : sortType == 3}">좋아요순</nav-item>
        </b-navbar-nav>
      </b-navbar>
      ...
      <b-navbar>
        <b-navbar-nav>
          <!-- b-nav-item 부트스트랩이라 글자색이 변경이 안된다. 어떻게 하는건지 물어보기 -->
          <nav-item @click="freeboardmaltype(0)" :class="{sortLetter : malType == 0}">전체</nav-item>
          &nbsp;
          <nav-item @click="freeboardmaltype(1)" :class="{sortLetter : malType == 1}">맛집추천</nav-item>
          &nbsp;
          <nav-item @click="freeboardmaltype(2)" :class="{sortLetter : malType == 2}">취미공유</nav-item>
          &nbsp;
          <nav-item @click="freeboardmaltype(3)" :class="{sortLetter : malType == 3}">부탁해요</nav-item>
          &nbsp;
          <nav-item @click="freeboardmaltype(4)" :class="{sortLetter : malType == 4}">분실신고</nav-item>
        </b-navbar-nav>
      </b-navbar>
      ...
      <table class="table table-hover">
        <thead>
          <tr class="table-secondary">
              ...
              <th class="col-md-1" scope="col">말머리</th>
        ...
        <tbody >
            <!-- <tr v-for="(freeboard) in this.$store.getters.allFreeboard" :key="freeboard.id" @click="movePage(freeboard.id, $event)"> -->
              <tr v-for="(freeboard) in fetchFreeboard" :key="freeboard.id" @click="movePage(freeboard.id, $event)">
                <td>{{freeboard.id}}</td>
                <td>{{types[freeboard.type]}}</td>
                <td>{{freeboard.title}}</td>
                <td>{{freeboard.writer}}</td>
                <!-- <td><small>{{freeboard.content | strFormat(freeboard.content)}}</small></td> -->
                <td>{{freeboard.view}}</td>
