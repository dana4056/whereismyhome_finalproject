  ...
  <div class="nbody">
    ...
    <form class="formwarp" method="post" action="/freeboard">
      ...
      <div class="form-foot form-group text-right">
          <input id="freeboardInsertBtn" class="vbtn black" type="submit" @click.prevent="submit"  value="수정">
...
export default {
  data(){
    return{
      title: this.$store.getters.freeboard.title,
      content: this.$store.getters.freeboard.content,
      view: this.$store.getters.freeboard.view,
  ...
  methods:{
    submit(){
      ...
      this.$store.dispatch('updateFreeboard', freeboard);
    }
  }
}
</script>
