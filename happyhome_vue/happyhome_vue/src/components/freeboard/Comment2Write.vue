...
export default {
  ...
  created(){
    this.$store.dispatch("getComment2List", this.no);
  },
  computed:{
    fetchComment(){
      return this.$store.state.comment2;
    },
    fecthList(){
      return this.$store.state.comments2
    }
  },
  methods: {
    registComment() {
      ...
      this.$store.dispatch("createComment2", comment);
    },
    updateComment() {
      ...
      this.$store.dispatch("updateComment2", payload);
      this.$store.commit("SET_COMMENT2", {});
    ...
    modifyCommentView(comment_no) {
      ...
      this.$store.dispatch("getComment2", comment_no);
    ...
    deleteComment(cnum) {
      ...
      if (confirm("정말로 삭제?")) {
        ...
        this.$store.dispatch("deleteComment2", payload);
      }
    },
    enterToBr(str) {
