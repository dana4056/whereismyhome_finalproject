        ...
        <section class="container align-middle p-5"> 
            <div class="wrap">
                <div class="form sign-up">
                    ...
                    <h1 class="style-1"> My Page </h1>
                    
                    <br>

                    <img v-bind="mainProps" rounded="circle" alt="Circle image" src="@/assets/user/person1.png"
                    width="75" height="75"/>

                    <br>
                    <br>

                    <h1 class="style-1"> {{fetchUser.id}}</h1>
                    ...
                    <div class="input-group">
                    <i class='bx bxs-lock-alt'></i>
                    <input type="text" placeholder="address" v-model="address" ref="address">
                    </div>

                    <div class="input-group">
                    <i class='bx bxs-lock-alt'></i>
                    <input type="text" placeholder="phone" v-model="phone" ref="phone">
                    </div>
                    ...
                    <p>
                    <span> Check your information. </span>
                    </p>
                </div>
            </div>
                <!-- </div> -->
...
export default {
    ...
    methods: {
      ...
      checkValue() {
        ...
        err && !this.email && ((msg = "전화번호를 입력해주세요"), (err = false), this.$refs.email.focus());
