  ...
  <div>
    <section class="noticeWrap container align-middle p-5">
      ...
      <caption>
        ...
        <router-link v-if="fetchUser.id === 'admin'" to="/notice/create" type="button" class="addbtn"> <i class="fa-solid fa-circle-plus fa-2x"></i></router-link>
      </caption>
      ...
      <b-navbar>
        ...
        &nbsp;
        <b-button id="searchBox" @click="search"> <i class="fa-sharp fa-solid fa-magnifying-glass"></i></b-button>
      </b-navbar>
