  ...
  <div class="nbody">
    ...
    <form class="formwarp" method="post" action="/qna">
      ...
      <div class="form-foot form-group text-right">
          <input id="qnaInsertBtn" class="vbtn black" type="submit" @click.prevent="submit"  value="수정">
...
export default {
  data(){
    return{
      ...
      content: this.$store.getters.qna.content,
      view: this.$store.getters.qna.view,
