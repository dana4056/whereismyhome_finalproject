  ...
  <div>
    <section class="container align-middle p-5">
      ...
      <caption>
        ...
        <b-button  @click="moveCreate" type="button" class="addbtn"> 
      ...
      <b-navbar>
        <b-navbar-nav>
          ...
          &nbsp;
          <nav-item @click="qnaSort(2)" :class="{sortLetter : sortType == 2, sortNot : sortType != 2}">조회수순</nav-item>
          &nbsp;
          <nav-item @click="qnaSort(3)" :class="{sortLetter : sortType == 3, sortNot : sortType != 3}">좋아요순</nav-item>
        </b-navbar-nav>
      </b-navbar>
